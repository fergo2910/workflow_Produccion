<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master_Cotizador.Master" AutoEventWireup="true" CodeBehind="MisCotizaciones.aspx.cs" Inherits="CotizadorWebAutos.Principal.MisCotizaciones" %>
    ...
    <div class="modal fade" id="modalERROR" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <asp:Label ID="lblRespuesta" runat="server" CssClass="alert-default"></asp:Label>
                </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p></p><asp:Label ID="txtForma" runat="server" Text="Label" Font-Bold="True"></asp:Label>
                    <p></p><asp:Label ID="txtNumero" runat="server" Text="Label" Font-Bold="True"></asp:Label>
                    <asp:Label ID="lblIdCotizacionDetalle" runat="server" Text="" Visible="false"></asp:Label>
                    <asp:Label ID="lblIdPlanDetalle" runat="server" Text="" Visible="false"></asp:Label>
                </div>
        ...
        <ContentTemplate>
            ...
            <div class="container">
                ...
                <div class="col-md-4 col-md-offset-4" style="text-align: center">
                    <h1>
                        <asp:Label ID="lblNombreCotizacion" runat="server" Text="Mis Cotizaciones" Font-Bold="true"></asp:Label></h1>
                </div>

                <div class="row"></div>

                <div style="align-content: center; height: 500px; overflow: auto">
                    <asp:GridView ID="grvCotizacionesIntermediario" CssClass="panel-danger" DataKeyNames="id_cotizacion" runat="server" AutoGenerateColumns="False" AllowSorting="True" HorizontalAlign="Center" Font-Size="Small" OnRowDataBound="grvCotizacionesIntermediario_RowDataBound">
                        <Columns>
                            ...
                            <asp:BoundField DataField="estado_coti" HeaderText="Estado Cotizacion">
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="Datos del vehículo">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnINS" Text="Ingresar" Visible="false" OnCommand="ingresarInspeccion" CommandArgument='<%# Eval("id_cotizacion") + ";" +Eval("id_plan_cotizado")%>' runat="server"></asp:LinkButton>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Autorización">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnAUT" Visible="false" Text="Ingresar" OnCommand="ingresarAutorizacion" CommandArgument='<%# Eval("id_cotizacion") + ";" +Eval("id_plan_cotizado")%>' runat="server"></asp:LinkButton>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Emitir Póliza">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Imprimir Cotización">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnIMP" Text="Imprimir" Visible="true" OnCommand="ingresarImpresion" CommandArgument='<%# Eval("id_cotizacion") + ";" +Eval("id_plan_cotizado")%>' runat="server"></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Eliminar Cotización">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnELI" Text="Eliminar" Visible="true" OnCommand="ingresarEliminar" CommandArgument='<%# Eval("id_cotizacion") + ";" +Eval("id_plan_cotizado")%>' runat="server"></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            </asp:TemplateField>
