<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master_Cotizador.Master" AutoEventWireup="true" CodeBehind="Consulta_Primas_Pendientes.aspx.cs" Inherits="CotizadorWebAutos.Oficina_Virtual.Consulta_Primas_Pendientes" %>
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="text-align: center">
                <h2>Consulta de primas pendientes</h2>
            </div>
            <div class="panel-body" style="overflow-y: auto; overflow-x: hidden; overflow-y: inherit">
                <div class="col-md-12">
                    <asp:Panel ID="PanelConsulta" runat="server" CssClass="" GroupingText="Parámetros de Consulta:" Style="border: none">
                        ...
                        • Debe seleccionar la fecha de fin de su búsqueda. 
                        <br /> 
                        • Su búsqueda no debe sobrepasar el mes actual (Fecha no mayor al mes actual).
                        <br />
                        <hr />
                    ...
                    <div class="col-md-12">
                        <asp:UpdatePanel ID="UpdatePanelBotones" runat="server" UpdateMode="Conditional">
                                    ...
                                    <asp:Panel ID="pnlResultadoPrimas" Visible="false" runat="server" GroupingText="Resultado de Búsqueda" Style="border: none">
                                        ...
                                        <div class="form-group col-md-4 col-lg-offset-2" style="text-align: center">
                                            ...
                                            <div class="form-inline">
                                                <asp:ImageButton ID="btnExportarPrimasPendientesExcel" Visible="true" ToolTip="Exportar datos a Excel" runat="server" OnClick="btnExportarPrimasPendientesExcel_Click" Height="50px" Width="50px" ImageUrl="~/Recursos/imagenes/excel-xls-icon.png" Enabled="true" />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <asp:ImageButton ID="btnExportarPrimasPendientes" Visible="true" ToolTip="Exportar datos a PDF" runat="server" OnClick="btnExportarPrimasPendientes_Click" Height="50px" ImageUrl="~/Recursos/imagenes/PDF-download.png" Width="50px" />
                                            </div>
                                        ...
                                        <div style="align-content: center; overflow: auto">
                                            <asp:GridView ID="grvResultadoPrimas" CssClass="panel-danger" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="fecvencfact" DataFormatString="{0:d/MM/yyyy}" HeaderText="Vencimiento">
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="mtofactlocal" HeaderText="Total">
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                    </asp:BoundField>
                                                </Columns>
                            ...
                            <Triggers>
                                <asp:PostBackTrigger ControlID="btnExportarPrimasPendientes" />
                                <asp:PostBackTrigger ControlID="btnExportarPrimasPendientesExcel" />
