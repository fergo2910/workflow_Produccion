            ...
            <div class="panel-body" style="overflow-y: auto; overflow-x: hidden; overflow-y: inherit">
                <div class="col-md-12">
                    <asp:Panel ID="PanelConsulta" runat="server" CssClass="" GroupingText="Parámetros de Consulta:" Style="border: none">
                        ...
                        <asp:Label runat="server" Text="• Debe ingresar al menos un dato para realizar la busqueda y haga clic en 'Buscar'."></asp:Label>
                        <br />
                        <hr />
                                            ...
                                            <div style="align-content: center; overflow: auto">
                                                <asp:GridView ID="grvVigencias" CssClass="panel-danger" DataKeyNames="" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnDetalleVigencias" Visible="true" Text="&nbsp;&nbsp;&nbsp;Detalle de vigencia&nbsp;&nbsp;&nbsp;"
                                                                    OnCommand="btnDetalleVigencias_Command" CommandArgument='<%# Eval("IDEPOL") %>' runat="server" ForeColor="Red"></asp:LinkButton>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:BoundField DataField="FECVIGENCIA" HeaderText="Vigencia">
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="STSPOL" HeaderText="Estado de póliza">
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="FECANUL" DataFormatString="{0:d/MM/yyyy}" HeaderText="Fecha anulada">
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:BoundField>
                                                    </Columns>
                                    ...
                                    <asp:Panel ID="pnlResultadoEstadoCuenta" Visible="false" runat="server" GroupingText="Estado de cuenta" Style="border: none">
                                        ...
                                        <asp:Panel ID="pnlEstadoCuenta" Visible="true" runat="server" Style="border: none; align-content: center" ScrollBars="None" Height="500" Width="100%">
                                            <div class="col-md-10 col-md-offset-1" style="align-content: center">
                                                <asp:Button ID="btnImprimirEstadoCuenta" OnClick="btnImprimirEstadoCuenta_Click" CssClass="btn btn-danger pull-right" runat="server" Text="Imprimir estado de cuenta" />
                                                <asp:Label ID="lblidepolseleccionado" runat="server" Text="" Visible="false"></asp:Label><%--<asp:Button ID="btnImprimirFacturas" OnClick="btnImprimirFacturas_Click" CssClass="btn btn-danger pull-left" runat="server" Text="Imprimir facturas seleccionadas" />--%>
                                                <br />
                                                <br />
                                                    ...
                                                    <Columns>
                                                        <%--<asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:LinkButton ID="btnDescargarFacturaRequerimiento" Visible="true" Text="Descargar factura individual" 
                                                                    OnCommand="btnDescargarFacturaRequerimiento_Command" CommandArgument='<%# Eval("IDEPOL") %>' runat="server" 
                                                        ...
                                                        <asp:BoundField DataField="numfact" HeaderText="No. de Factura">
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="giros" HeaderText="Pagos">
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="fecvencfact" HeaderText="Vencimiento">
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="pagada" HeaderText="Pagado">
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="fecstsreling" HeaderText="Fecha de pago">
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="atraso" HeaderText="Días de atraso">
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:BoundField>
                                                    </Columns>
                                                ...
                                                <br />
                                                <asp:GridView ID="grvSaldosFavor" CssClass="panel-danger" runat="server" AutoGenerateColumns="False"
                                                    CellPadding="5" RowStyle-HorizontalAlign="center" ClientIDMode="AutoID"
                                                    AllowSorting="True" HorizontalAlign="Center" Font-Size="Small">
                                                    <Columns>
                                                        <asp:TemplateField>
